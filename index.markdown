...
<div dir="rtl" lang="he" class="memorial-page">
  <section class="hero">
    ...
    <div class="hero-content">
      ...
      <h1>סיפורים, חברים, וזיכרונות </h1>
      <p class="hero-description"> האתר מרכז את פרויקטי ההנצחה, רגעים ספורטיביים והדרך שבה  ממשיכים לזכור את עומרי בכל יום.</p>
    </div>
  </section>
  ...
  <section class="project-links">
    ...
    <div class="project-grid">
      <article class="project-card">
        <h3>אתגר הסוכר</h3>
        <p>חודש של סיפורים, תמונות וחוויות של משתתפים שניסו להימנע ממזון עם סוכר מוסף .</p>
  ...
  <section class="details-intro">
    ...
    <p>כאן תמצאו את הסיפורים המלאים מאחורי כל יוזמה, כולל רגעים אישיים וזיכרונות מהשטח.</p>
  </section>
  ...
  <h2>מירוצים</h2>
    <p>עמרי היה אצן מצטיין, זכה במספר מרוצים על מסלולי הבית והאזור. הוא היה טיפוס של מטרה, שראה כל ריצה כהזדמנות להיות טוב יותר.</p>
